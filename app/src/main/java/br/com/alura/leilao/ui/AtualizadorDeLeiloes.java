...
public class AtualizadorDeLeiloes {
    ...
    public void buscaLeiloes(ListaLeilaoAdapter adapter, LeilaoWebClient client, ErroCarregaLeiloesListener erroListener) {
    ...
    public interface ErroCarregaLeiloesListener {
        void erroAoCarregar(String menssagem);
    }
}
